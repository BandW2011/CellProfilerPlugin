...
__doc__ = '''
<b>Export To Spreadsheet Plus</b> exports measurements into one or more files that can be
opened in Excel or other spreadsheet programs. Has added features.
<hr>
...
<b>ExportToSpreadsheetPlus</b> can write out separate files for groups of images based
...
class ExportToSpreadsheetPlus(cpm.CPModule):

    module_name = 'ExportToSpreadsheetPlus'
    ...
    def create_settings(self):
        ...
        self.wants_prefix = cps.Binary(
            ...
            <b>ExportToSpreadsheetPlus</b>. A prefix may be useful if you use
        ...
        self.prefix = cps.Text(
            ...
            produced by <b>ExportToSpreadsheetPlus</b>.
            """ %globals())
        ...
        self.wants_overwrite_without_warning = cps.Binary(
            ...
            old .CSV files by <b>ExportToSpreadsheetPlus</b> without confirmation.
        ...
        self.wants_aggregate_means = cps.Binary(
            ...
            Select <i>%(YES)s</i> for <b>ExportToSpreadsheetPlus</b> to calculate population statistics over all the
            objects in each image and save that value as an aggregate
            measurement in the Image file.  For instance, if you are measuring
            the area of the Nuclei objects and you check the box for this option, <b>ExportToSpreadsheetPlus</b> will
            create a column in the Image file called "Mean_Nuclei_AreaShape_Area".

            <p>You may not want to use <b>ExportToSpreadsheetPlus</b> to calculate these
        ...
        self.wants_everything = cps.Binary(
            ...
            <b>ExportToSpreadsheetPlus</b> will create one data file for each object produced
    ...
    def add_object_group(self,can_remove = True):
        ...
        group.append(
            ...
            or an object name from the list. <b>ExportToSpreadsheetPlus</b> will write out a
        ...
        group.append("file_name", cps.Text(
            ...
            measurements. <b>ExportToSpreadsheetPlus</b> will
    ...
    def validate_module_warnings(self, pipeline):
        ...
        if pipeline.test_mode:
            raise cps.ValidationError("ExportToSpreadsheetPlus will not produce output in Test Mode",
                                      self.directory)
    ...
    def run_as_data_tool(self, workspace):
        ...
        For ExportToSpreadsheetPlus, we do the "post_run" method in order to write
...
Do you want to save it anyway?""" %
    ...
    def prepare_to_create_batch(self, workspace, fn_alter_path):
        ...
        ExportToSpreadsheetPlus has to convert the path to file names to
...
ExportToExcelPlus = ExportToSpreadsheetPlus
